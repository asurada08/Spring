...
<body>
 ...
 <form:form method="post" commandName="userVO"  action="regist">
  ...
  <tr>
		<td>비밀번호 확인</td>
		<td>
		<input type="password" name="user_pwd_confirm">
		</td>
  </tr>
  <tr>
		<td>비밀번호 질문</td>
		<td>
		<input type="text" name="user_pwd_hint"
		value="${userVO.user_pwd_hint}">
		<div id="user_id_msg">
  ...
  <tr>
		<td>비밀번호 답</td>
		<td><input type="text" name="user_pwd_answer" 
		value="${userVO.user_pwd_answer}">
		<div id="user_id_msg">
  ...
  <tr>
		<td>주소</td>
		<td>
			<input type="text" name="user_addr1" id="user_addr"
...
<h1>나는 해바라기 지요.</h1>
<img alt="그림을 넣어 보자" 
src="../resources/image/Sunflower.jpg">
</body>
</html>
